...
# ราคากลางจากบัญชีราคากลาง กรมบัญชีกลาง (อ้างอิง CODE จากไฟล์ราคากลาง.xlsx)
# หน่วย: บาท/หน่วย  |  mat = ค่าวัสดุ, labor = ค่าแรง
DEFAULT_PRICES = {
    # === งานดิน ===
    # A1007: ขุดดินทั่วไป ค่าแรง 60 บาท/ลบ.ม.
    "งานดินขุด":               {"unit": "ลบ.ม.", "mat": 0,      "labor": 60},
    # A1016: ถมดิน วัสดุ 413 + ค่าแรง 99
    "ดินถม":                   {"unit": "ลบ.ม.", "mat": 413,    "labor": 99},

    # === วัสดุรองฐานราก ===
    # A1011: ทรายหยาบรองพื้น วัสดุ 495 + ค่าแรง 104
    "ทรายหยาบ (หนา 0.05m)":   {"unit": "ลบ.ม.", "mat": 495,    "labor": 104},
    # A1013: คอนกรีตหยาบ 1:3:5 ประเภท 1  วัสดุ 1,610 + ค่าแรง 426
    "คอนกรีตหยาบ (หนา 0.05m)":{"unit": "ลบ.ม.", "mat": 1610,   "labor": 426},

    # === คอนกรีตโครงสร้าง ===
    # A4001: คอนกรีต 1:2:4 โครงสร้างติดดิน วัสดุ 1,845 + ค่าแรง 466
    "คอนกรีตโครงสร้าง":        {"unit": "ลบ.ม.", "mat": 1845,   "labor": 466},

    # === ไม้แบบ ===
    # A3001+A3009: ไม้แบบทั่วไปอาคารชั้นเดียว วัสดุ 400 บาท/ลบ.ฟ. ≈ 1,413 บาท/ตร.ม.
    # ค่าแรง A3010: 139 บาท/ตร.ม. (น้อยกว่า 5,000 ตร.ม.)
    "ไม้แบบฐานราก":            {"unit": "ตร.ม.", "mat": 200,    "labor": 139},
    "ไม้แบบตอม่อ":              {"unit": "ตร.ม.", "mat": 200,    "labor": 139},

    # === เหล็กเสริม (ราคา/กก. แปลงจากราคา/ตัน) ===
    # A5001: RB6  SR24 = 22,750 บาท/ตัน → 22.75 บาท/กก.  ค่าแรง 4,400 บาท/ตัน → 4.40 บาท/กก.
    "RB6":  {"unit": "กก.", "mat": 22.75, "labor": 4.40},
    # A5002: RB9  SR24 = 22,000 บาท/ตัน → 22.00 บาท/กก.
    "RB9":  {"unit": "กก.", "mat": 22.00, "labor": 4.40},
    # DB10: ใช้ค่าใกล้เคียง DB12
    "DB10": {"unit": "กก.", "mat": 22.10, "labor": 3.60},
    # A5013: DB12 SD40 = 22,100 บาท/ตัน → 22.10 บาท/กก.  ค่าแรง 3,600 บาท/ตัน → 3.60 บาท/กก.
    "DB12": {"unit": "กก.", "mat": 22.10, "labor": 3.60},
    # A5014: DB16 SD40 = 21,900 บาท/ตัน → 21.90 บาท/กก.
    "DB16": {"unit": "กก.", "mat": 21.90, "labor": 3.60},
    # A5015: DB20 SD40 = 21,900 บาท/ตัน → 21.90 บาท/กก.  ค่าแรง 3,100 บาท/ตัน → 3.10 บาท/กก.
    "DB20": {"unit": "กก.", "mat": 21.90, "labor": 3.10},
    # A5016: DB25 SD40 = 21,900 บาท/ตัน → 21.90 บาท/กก.
    "DB25": {"unit": "กก.", "mat": 21.90, "labor": 3.10},
    # A5017: DB28 SD40 = 21,900 บาท/ตัน → 21.90 บาท/กก.
    "DB28": {"unit": "กก.", "mat": 21.90, "labor": 3.10},
    # A5028: DB32 SD50 = 20,150 บาท/ตัน → 20.15 บาท/กก.
    "DB32": {"unit": "กก.", "mat": 20.15, "labor": 3.10},

    # === ลวดผูกเหล็ก ===
    # A5035: ลวดผูกเหล็ก ขนาด 1.25มม. (เบอร์18) = 25 บาท/กก.
    "ลวดผูกเหล็กฐานราก":       {"unit": "กก.", "mat": 25,     "labor": 0},
    "ลวดผูกเหล็กตอม่อ":        {"unit": "กก.", "mat": 25,     "labor": 0},
}
...
"""
        ...
        with src_col1:
            if "price_source" not in st.session_state:
                st.session_state.price_source = "บัญชีราคากลางงานก่อสร้าง กรมบัญชีกลาง"
